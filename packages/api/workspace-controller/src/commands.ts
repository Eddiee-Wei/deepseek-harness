...
export class WorkspaceCommands {
  ...
  /**
   * Resolve the canonical directory owned by one registered Workspace.
   * @param workspaceId - Workspace identity from a trusted Remote request.
   * @returns the registered canonical directory.
   */
  pathFor(workspaceId: WorkspaceId): string {
