...
export type {
  ...
  CredentialView, DirectoryListing, DiscoveredModelView, HistoryEntry, HostFrame, HostPathApplication, IApiClient,
  ...
  WorkspaceId, WorkspaceRepositoryView, WorkspaceView,
