...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote(\'repository\') async repository( request: WorkspaceRepositoryRequest, signal: AbortSignal, ): Promise<WorkspaceRepositoryValue>',
        description: 'Inspect Git state for one registered Workspace.',
        parameters: [{ name: 'request', description: 'registered Workspace identity.' }, { name: 'signal', description: 'caller lifetime; abort terminates Git inspection.' }],
        returns: 'directory or Git repository state.',
      },
      {
        signature: '@Remote(\'openPathWith\') async openPathWithApplication( request: WorkspaceOpenPathWithRequest, signal: AbortSignal, ): Promise<WorkspaceOpenPathWithValue>',
        description: 'Open one registered Workspace in an allowlisted macOS application.',
        parameters: [{ name: 'request', description: 'Workspace identity and named destination.' }, { name: 'signal', description: 'caller lifetime; abort terminates the native command.' }],
        returns: 'confirmation after LaunchServices accepts the request.',
      },
      {
        signature: '@Remote(\'createBranch\') async createBranch( request: WorkspaceCreateBranchRequest, signal: AbortSignal, ): Promise<WorkspaceCreateBranchValue>',
        description: 'Create and switch to a new branch in one registered Workspace.',
        parameters: [{ name: 'request', description: 'Workspace identity and previously unused branch name.' }, { name: 'signal', description: 'caller lifetime; abort terminates Git commands.' }],
        returns: 'repository state after the branch switch.',
      },
      {
        signature: '@Remote(\'createWorktree\') async createWorktree( request: WorkspaceCreateWorktreeRequest, signal: AbortSignal, ): Promise<WorkspaceCreateWorktreeValue>',
        description: 'Create a linked worktree and register it as a Workspace.',
        parameters: [{ name: 'request', description: 'Workspace identity and previously unused branch name.' }, { name: 'signal', description: 'caller lifetime; abort terminates Git commands.' }],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'WorkspaceCreateBranchRequest',
    declaration: 'export interface WorkspaceCreateBranchRequest {\n    readonly workspaceId: WorkspaceId;\n    readonly branch: string;\n}',
  },
  {
    name: 'WorkspaceCreateBranchValue',
    declaration: 'export interface WorkspaceCreateBranchValue {\n    readonly repository: WorkspaceRepositoryView;\n}',
  },
  {
  ...
  {
    name: 'WorkspaceCreateWorktreeRequest',
    declaration: 'export interface WorkspaceCreateWorktreeRequest {\n    readonly workspaceId: WorkspaceId;\n    readonly branch: string;\n}',
  },
  {
    name: 'WorkspaceCreateWorktreeValue',
    declaration: 'export interface WorkspaceCreateWorktreeValue {\n    readonly workspace: WorkspaceView;\n}',
  },
  {
  ...
  {
    name: 'WorkspaceOpenPathWithRequest',
    declaration: 'export interface WorkspaceOpenPathWithRequest {\n    readonly workspaceId: WorkspaceId;\n    readonly application: WorkspacePathApplication;\n}',
  },
  {
    name: 'WorkspaceOpenPathWithValue',
    declaration: 'export interface WorkspaceOpenPathWithValue {\n    readonly opened: true;\n}',
  },
  {
  ...
  {
    name: 'WorkspacePathApplication',
    declaration: 'export type WorkspacePathApplication = \'vscode\' | \'cursor\' | \'finder\' | \'terminal\';',
  },
  {
  ...
  {
    name: 'WorkspaceRepositoryRequest',
    declaration: 'export interface WorkspaceRepositoryRequest {\n    readonly workspaceId: WorkspaceId;\n}',
  },
  {
    name: 'WorkspaceRepositoryValue',
    declaration: 'export interface WorkspaceRepositoryValue {\n    readonly repository: WorkspaceRepositoryView;\n}',
  },
  {
    name: 'WorkspaceRepositoryView',
    declaration: 'export type WorkspaceRepositoryView = {\n    readonly kind: \'directory\';\n} | {\n    readonly kind: \'git\';\n    readonly root: string;\n    readonly branch?: string;\n    readonly detached: boolean;\n    readonly dirty: boolean;\n};',
  },
  {
    name: 'WorkspaceValue',
