...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-not-git'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('workspace-git-dirty'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('workspace-branch-invalid'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('workspace-branch-exists'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('workspace-worktree-exists'), message: z.string(), details: z.object({}) }),
