...
export interface RpcMethodMap {
  ...
  'host.openPathWith': HostApi['openPathWith']
  ...
  'workspace.repository': WorkspaceApi['repository']
  'workspace.createBranch': WorkspaceApi['createBranch']
  'workspace.createWorktree': WorkspaceApi['createWorktree']
