...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceCreateBranchRequest: 'workspace.md',
  WorkspaceCreateBranchValue: 'workspace.md',
  WorkspaceCreateRequest: 'workspace.md',
  WorkspaceCreateWorktreeRequest: 'workspace.md',
  WorkspaceCreateWorktreeValue: 'workspace.md',
  ...
  WorkspaceOpenPathWithRequest: 'workspace.md',
  WorkspaceOpenPathWithValue: 'workspace.md',
  WorkspaceRenameRequest: 'workspace.md',
  WorkspaceRepositoryRequest: 'workspace.md',
  WorkspaceRepositoryValue: 'workspace.md',
