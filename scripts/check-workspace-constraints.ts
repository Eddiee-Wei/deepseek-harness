...
/** Installable application roots assembled as platform artifacts rather than published to npm. */
const privateApplicationDirectories = new Set(['apps/desktop', 'apps/macos'])
